...
class BoardTest(unittest.TestCase):
    ...
    def test_remove_stones(self):
        board = board_lib.Board()
        board.place(Point(row=3, col=3), player=Player.White)
        board.place(Point(row=2, col=3), player=Player.Black)
        board.place(Point(row=4, col=3), player=Player.Black)
        board.place(Point(row=3, col=2), player=Player.Black)
        board.place(Point(row=3, col=4), player=Player.Black)
        self.assertEqual(
            board.ascii_board(),
            """.#.................
               #.#................
